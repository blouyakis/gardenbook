...
_(If consent is not given, thank the participant and end the session. Do not record.)_
...
>
> **Was it implemented? How?**
> Yes we implemented this by moving the search bar to the top of the home page.
